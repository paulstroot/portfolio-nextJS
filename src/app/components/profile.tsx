			...
			<div className="container m-auto ">
				<div className="flex flex-col md:flex-row gap-12">
					...
					<div className="w-full md:w-1/2 prose">
						<h2>About Paul</h2>
						<p>
							Born and raised in Wisconsin but a proud Minnesotan for the past three decades,
							I&apos;ve made South Minneapolis my home. As a contract developer who&apos;s been
							writing code since, well, forever, I&apos;ve had the privilege of working on diverse
							projects that keep every day interesting and challenging.
						</p>

						<p>
							Life&apos;s too short not to have hobbies that keep your hands busy and your mind
							engaged. When not coding, you can probably find me doing one of the following:
						</p>
						<ul>
							<li>Snowboarding</li>
							<li>Biking</li>
