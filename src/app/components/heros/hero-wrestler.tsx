		...
		>
			<div className="relative md:absolute top-0 z-0 hero-image h-full right-0 left-0 ">
				<Image
					...
					loading="eager"
					alt=""
					className="w-[150%] ml-[-50%] md:w-full md:h-full object-cover max-h-none max-w-none md:ml-auto block h-full "
					aria-hidden="true"
				/>
			</div>
			...
			<div className="relative z-2 container mx-auto text-background-contrast flex flex-col md:flex-row justify-center align-center">
				<div className="w-full py-16 md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
					...
					<h2 className="hero-tagline">Heavyweight champ of dev</h2>
					<p>
						Droppin’ elbows on bugs and body-slamming bad code. Tag me in when it’s time to lay the
						smackdown on your next project!
					</p>
