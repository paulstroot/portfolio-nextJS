"use client"
import { sanitizeContentfulRichText, sanitizeImageUrl } from "@/app/utilities/sanitize"
				...
				>
					...
					<ModalBody className="modal-body">
						<div className="modal-body space-y-6">
							<Image
								src={sanitizeImageUrl(activeProject.fields.featuredImage.fields.file.url)}
								width={577}
								height={500}
							...
							<aside className="">
								...
								<div className="flex flex-wrap gap-2">
									{(activeProject.fields.skills ?? []).map((skill, i: number) => {
										const icon = skill.fields.icon?.fields.file.url && (
											<Image
												src={sanitizeImageUrl(skill.fields.icon?.fields.file.url)}
												width={5}
												height={5}
												alt="desktop-monitor"
